...
public class WristInfoGizmo : MonoBehaviour
{
    ...
    public void ShowWristInformation()
    {
        ...
        leftWrist3D.transform.localPosition = ManoUtils.Instance.CalculateNewPositionDepth(new Vector3(wristInfo.left_point.x, wristInfo.left_point.y, 0), ManomotionManager.Instance.Hand_infos[0].hand_info.tracking_info.depth_estimation);
        rightWrist3D.transform.localPosition = ManoUtils.Instance.CalculateNewPositionDepth(new Vector3(wristInfo.right_point.x, wristInfo.right_point.y, 0), ManomotionManager.Instance.Hand_infos[0].hand_info.tracking_info.depth_estimation);
        Debug.Log("Calcuate Wrist");
